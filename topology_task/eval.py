...
if __name__ == "__main__":
    ...
    parser.add_argument('--ppi_path', type=str,
                        help='path to the predicted PPIs (Take BFS as an example)')
    parser.add_argument('--out_path', type=str,
                        help='path to save the evaluation results')
    parser.add_argument('--gt_graph_path', type=str,
                        help='path to the ground truth graph')
    parser.add_argument('--test_graph_node_path', type=str,
                        help='path to the test graph nodes')
    ...
    gt_graph_path = args.gt_graph_path
    test_graph_node_path = args.test_graph_node_path
    ...
    for k in keys:
        for sub_key in graph_level_results[k]:
            results_list[k].append(graph_level_results[k][sub_key])
