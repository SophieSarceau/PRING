...
base_path = "../species_processed_data/human/"

graph_path = "../species_processed_data/human/human_graph.pkl"
ppi_path = "../species_processed_data/human/human_ppi.txt"
...
if __name__ == '__main__':
    ...
    for method in tqdm(method_list):
        ...
        train_ppi_neg_pairs = sample_negatives(train_ppi_pos_pairs, None, total_ppis)
        test_ppi_neg_pairs = sample_negatives(test_ppi_pos_pairs, None, total_ppis)
        ...
        # write to txt file
        train_path = os.path.join(base_path, method, 'human_train_ppi.txt')
        val_path = os.path.join(base_path, method, 'human_val_ppi.txt')
        test_path = os.path.join(base_path, method, 'human_test_ppi.txt')
