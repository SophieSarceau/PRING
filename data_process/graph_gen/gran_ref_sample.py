...
# species_list = ['human', 'ecoli', 'mouse', 'pig', 'ponab', 'yeast', 'arath']
# species_list = ['human', 'ecoli', 'yeast', 'arath']
species_list = ['yeast', 'arath', 'ecoli']
method_list = ['BFS', 'DFS', 'RANDOM_WALK']
base_path = '../string_ppi_network/'
    ...
    for species in species_list:
        if species == 'human':
            for method in method_list:
                ...
                output_path = os.path.join(base_path, species, method, 'test_ref_sampled_nodes.pkl')
            ...
            for method in method_list:
                ...
                for num_nodes in tqdm(sample_node_list):
                    for i in range(graph_num):
                        ...
                        sampled_nodes_dict[num_nodes].append(sampled_nodes)
                output_path = os.path.join(base_path, species, species + '_' + method + '_ref_sampled_nodes.pkl')
                pickle.dump(sampled_nodes_dict, open(output_path, 'wb'))
